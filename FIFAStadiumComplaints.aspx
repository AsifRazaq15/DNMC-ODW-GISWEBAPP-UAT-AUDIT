          ...
          <div class="cards">
                  ...
                  <button id="btnRefresh" OnClick="ReloadPage()"  style="margin-bottom:12px;color: #fff;background-color: #154670; height: 27px;width: 90px;border: solid 1px #fff;font-size: 15px;font-weight: bold; border-radius: 2px 2px 2px 2px;">Refresh</button>
                   <br /> <label style="border: solid 1px #fff;">View: <label id="lblStadium" runat="server"></label></label><br /> 
                    <div style="margin-top:10px;">
                        <asp:LinkButton id="rainWater" runat="server" OnClick="btn_RainWater" style="color:#fff;" Text="RainWater"/><br />
                        <asp:LinkButton id="nonRainWater" runat="server" OnClick="btn_NonRainWater" style="color:#fff;" Text="Non-RainWater"/>
                    </div>
              </div>
              <div class="card" style="margin-left:6rem;">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="InProg" HeaderText="In Progress" ItemStyle-Width="50" HeaderStyle-CssClass="addwidth" />
                    <asp:BoundField DataField="Complete" HeaderText="Work Complete" ItemStyle-Width="50" HeaderStyle-CssClass="addwidth" />
