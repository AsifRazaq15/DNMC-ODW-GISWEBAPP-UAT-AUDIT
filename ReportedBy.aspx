<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportedBy.aspx.cs" Inherits="WebAppForm.ReportedBy" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Reported By - Work Order</title>
    <style type="text/css">
        .Grid {
...
<body style="background-color: #022130; font-family: Segoe UI Light; color: white;">
    <form id="form1" runat="server" style="text-align: center;">
        <div>
            ...
            <div>
                <span style="font-size: 16px; margin-right: 10px;">Display Name:</span>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>" 
                SelectCommand="SELECT PERSONID,DISPLAYNAME,TITLE,EXT_RESPSECTION,EXT_UNIT,EXT_RESPAREA FROM EAMS.DIMPERSON WHERE PERSONID IS NOT NULL and STATUS='ACTIVE' ORDER BY PERSONID"
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>" 
                SelectCommand="SELECT COUNT(*) AS TotalRows FROM EAMS.DIMPERSON WHERE PERSONID IS NOT NULL and STATUS='ACTIVE'"></asp:SqlDataSource>
            <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" Font-Size="12px" Font-Names="Segoe UI Light"
                DataKeyNames="PERSONID" CellPadding="10" CellSpacing="10" PageSize="10" AllowPaging="true" OnPageIndexChanging="gvCustomers_PageIndexChanging"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EXT_RESPSECTION" HeaderText="EXT_RESPSECTION"  />
                    <asp:BoundField DataField="EXT_UNIT" HeaderText="EXT_UNIT"  />
                      <asp:BoundField DataField="EXT_RESPAREA" HeaderText="EXT_RESPAREA"  />
            ...
            <script type="text/javascript">
                function GetSelectedRow(lnk) {
                    ...
                    if (window.opener != null && !window.opener.closed) {
                        ...
                        window.opener.document.getElementById("ContentPlaceHolder1_txtReportedBy").value = name;
                        return false;
                    }
                    window.close();
                }
