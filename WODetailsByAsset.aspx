<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WODetailsByAsset.aspx.cs" Inherits="WebAppForm.WODetailsByAsset" %>
    ...
    <form id="form1" runat="server" style="text-align: center;">
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>"
                ...
                AND ASSETNUM=(SELECT TOP(1) Asset_ID FROM [SCADA].[MXLocations_Assets] WHERE Hierarchical_SiteName = @hSiteName) order by changedate desc">
                <SelectParameters>
                    <asp:QueryStringParameter DbType="String" DefaultValue="" Name="hSiteName" QueryStringField="hSiteName" />
                    <asp:QueryStringParameter DbType="String" DefaultValue="" Name="AssetType" QueryStringField="AssetType" />
            ...
            wo.[Status] NOT IN ('CAN','CLOSE','COMP','HISTEDIT','SRVPARRST','THDPTY','WRKCOMP','QC') and ASSETNUM=(SELECT TOP(1) Asset_ID FROM [SCADA].[MXLocations_Assets] WHERE Hierarchical_SiteName = @hSiteName)">
                <SelectParameters>
                    <asp:QueryStringParameter DbType="String" DefaultValue="" Name="hSiteName" QueryStringField="hSiteName" />
                    <asp:QueryStringParameter DbType="String" DefaultValue="" Name="AssetType" QueryStringField="AssetType" />
                    <asp:ControlParameter ControlID="drpDwnWType" DbType="String" Name="WType" PropertyName="SelectedValue" />
