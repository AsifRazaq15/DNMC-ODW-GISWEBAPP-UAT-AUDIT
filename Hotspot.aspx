<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hotspot.aspx.cs" Inherits="WebAppForm.Hotspot" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hotspot - Sharepoint List</title>
    <style type="text/css">
        .Grid {
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlField1" runat="server" CssClass="textfield" Width="150">
                            <asp:ListItem Value="refno">Hotspot ID</asp:ListItem>
                            <asp:ListItem Value="Municipality">Municipality</asp:ListItem>
                            <asp:ListItem Value="District">District</asp:ListItem>
                            <asp:ListItem Value="location">Location</asp:ListItem>
                            <asp:ListItem Value="FM19ECCSTATUSValue">ECC Status</asp:ListItem>
                        </asp:DropDownList></td>
