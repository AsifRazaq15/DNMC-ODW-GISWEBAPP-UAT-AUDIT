<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Location_List.aspx.cs" Inherits="WebAppForm.Location_List" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Get Location List</title>
    <style type="text/css">
        .Grid {
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlField1" runat="server" CssClass="textfield" Width="150">
                                <asp:ListItem Value="LOCATION">LOCATION NUM</asp:ListItem>
