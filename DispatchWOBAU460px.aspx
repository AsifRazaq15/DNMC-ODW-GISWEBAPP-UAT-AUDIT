<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.DispatchWOBAU460px"
    Title="Dispatch Work Order" CodeBehind="DispatchWOBAU460px.aspx.cs" %>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 8px;">
                            ...
                            <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectContract();return false;" Width="20" Height="20" ID="imgbtnContract" Style="vertical-align: middle;" />
                    ...
                    <tr>
                        ...
                        <td class="requiredvalue" style="text-align: left; padding-right: 0px; padding-left: 7px; padding-top: 10px;">
                            ...
                            <asp:TextBox ID="txt_Crew" runat="server" CssClass="textfield" Width="186px">
                            </asp:TextBox>
