<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.DispatchWO460px"
    Title="Dispatch Work Order (O/P)" CodeBehind="DispatchWO460px.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="table1" style="border-collapse: collapse;" width="460" border="0">
        <tr>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    ECC Express Form - Dispatch WO (O/P)<br />
                </p>
            ...
            <td>
                <table width="100%">
                    <tr style="display:none">
                        <td class="requiredvalue" colspan="2" style="text-align: right; width: 52%;">
                            <asp:LinkButton Style="padding-left: 10px; float: right;" ID="lnkbtnback" runat="server" Text="Back" Visible="false" Font-Names="Segoe UI Light" Font-Size="Small" ForeColor="White" />
                    ...
                    <tr>
                        ...
                        <td class="requiredvalue" style="text-align: left;">
                            <asp:DropDownList ID="ddlOwnership" runat="server" CssClass="textfield" Width="186px" Enabled="false" Style="border: none; border-radius: 5px; -webkit-appearance: none;">
                    ...
                    <tr>
                        ...
                        <td class="requiredvalue">
                            ...
                            <asp:DropDownList ID="ddlPriority" runat="server" CssClass="textfield" Width="186" Enabled="false" Style="border: none; border-radius: 5px; -webkit-appearance: none;">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px;">
                            <asp:TextBox ID="txtScheduler" runat="server" class="textfield" Width="186px" ReadOnly="true" />
                    ...
                    <tr>
                     ...
                     <tr>
                            ...
                            <td style="padding-left: 8px;">
                                <asp:TextBox ID="txtHotspot" runat="server" class="textfield" Width="186" MaxLength="250" />
                    ...
                    <tr>
                            ...
                            <td class="requiredvalue" style="padding-left: 8px;">
                                <asp:TextBox ID="txtProject" runat="server" class="textfield" Width="186" MaxLength="250" />
                                <asp:ImageButton runat="server" ImageUrl="images/search.png"  OnClientClick="SelectPABoundary();" Width="20" Height="20" ID="imgbtnProject" Style="vertical-align: middle;" />
    ...
    <script type="text/javascript">
        ...
        function SelectContract() {
            popup = window.open("Contract.aspx", "_blank", "width=800,height=720");
            popup.focus();
            return false;
        }
        ...
        function SelectCrew() {
            ...
            debugger;
            if (companyKey != "") {
                popup = window.open("Crew.aspx?Company=" + companyKey, "_blank", "width=800,height=720");
                popup.focus();
            } else {
                popup = window.open("Crew.aspx", "_blank", "width=800,height=720");
                popup.focus();
            }
            return false;
        }
        ...
        function Select_ECC_Crew() {
            ...
            debugger;
            if (txtOwner != "") {
                popup = window.open("ECCCrew.aspx?ID=" + txtOwner, "_blank", "width=600,height=620");
                popup.focus();
            }
            return false;
        ...
        function SelectScheduler() {
            ...
            debugger;
            if (companyKey != "") {
                popup = window.open("Scheduler.aspx?Company=" + companyKey, "_blank", "width=800,height=720");
                popup.focus();
            } else {
                popup = window.open("Scheduler.aspx", "_blank", "width=800,height=720");
                popup.focus();
            }
            return false;
        }
