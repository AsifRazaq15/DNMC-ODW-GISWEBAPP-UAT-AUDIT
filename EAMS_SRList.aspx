<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EAMS_SRList.aspx.cs" Inherits="WebAppForm.EAMS_SRList" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Get EAMS SR List</title>
    <style type="text/css">
        .Grid {
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlField1" runat="server" CssClass="textfield" Width="150">
                                ...
                                <asp:ListItem Value="EXT_DEFECTTYPE">DEFECT_TYPE</asp:ListItem>
