<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.CreateSR"
    Title="Create SR" CodeBehind="CreateSR.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="width: 34%;">
                                <asp:TextBox ID="txtFrameZone" CssClass="textfield" Width="185" runat="server" Style="height: 30px; width: 185px; border: none;"/>
                            </td>
                        </tr>
                        <tr>
                           
                             <td class="required"><span style="color: red;">* </span>Summary:</td>
                            <td>
                                <asp:TextBox ID="txtSummary" runat="server" class="textfield" Style="margin-left: 8px;" TextMode="MultiLine" Height="50" Width="185" Rows="30" Columns="20"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="reqtxtSummary" runat="server" ControlToValidate="txtSummary" Display="None" EnableClientScript="true"
                                    ValidationGroup="test" Text="*" ErrorMessage="WO Summary is Required" ForeColor="white" />
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="requiwhite" align="right" style="text-align: right; width: 18%;">
                                <span class="normal" style="font-weight: bold;">Details:</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="width: 34%;">
                                ...
                                <asp:DropDownList ID="drpDwnReprtedPriority" runat="server" CssClass="textfield" Width="186px">
                            ...
                            <td>
                                <asp:DropDownList ID="DrpDwnIntrnalPriority" runat="server" CssClass="textfield" Width="186px" Style="margin-left: 8px;">
                                    <asp:ListItem Value="1" Selected="True">1- Urgent</asp:ListItem>
                                    <asp:ListItem Value="2">2- High</asp:ListItem>
                                    <asp:ListItem Value="3">3- Medium</asp:ListItem>
                                    <asp:ListItem Value="4">4- Low</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="width: 34%;">
                                ...
                                <asp:DropDownList ID="DrpDwnLstSrType" runat="server" CssClass="textfield" Width="186px" Style="border: none;" Enabled="false">
                            ...
                            <td class="required"><span style="color: red;">* </span>Service Provider Team:</td>
                            <td>
                                <asp:TextBox ID="TxtboxSRGrp" Text="DR_CSRL2" runat="server" class="textfield" Style="margin-left: 9px;" Width="186" ToolTip="CSR L2 Group for Drainage" />
                                <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectSPGroup()" Width="20" Height="20" ID="ImageButton2" Style="vertical-align: middle;" />
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TxtboxSRGrp" Display="None" EnableClientScript="true"
                                    ValidationGroup="test" Text="*" ErrorMessage="Service Provider Team is Required" ForeColor="white" />
    ...
    <script type="text/javascript">
        ...
        function SelectAsset() {
            ...
            popup = window.open("Asset.aspx?LocationId=" + name + "&IsLocation=1&IsFrameWorkZone=1", "Popup", "width=800,height=720");
            popup.focus();
            return false;
        }
        ...
        function SelectSPGroup() {
            popup = window.open("SPGroup.aspx", "Popup", "width=800,height=720");
            popup.focus();
            return false;
        }
