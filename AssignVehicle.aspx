<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignVehicle.aspx.cs" Inherits="WebAppForm.AssignVehicle" 
    ...
    <table runat="server" id="tblConfirm">
        <tr>
            ...
            <td style="padding-left: 10px;">
                <asp:Label ID="lblConfirm" runat="server" Font-Bold="true" Text="" BorderWidth="1"
                    class="textfield" Style="width: 250px; font-size: 1.1em;text-wrap:normal;" />
            </td>
