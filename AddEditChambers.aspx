<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.AddEditChambers"
    Title="Add Chambers" CodeBehind="AddEditChambers.aspx.cs" %>
        ...
        <div class="modal-dialog modal-sm">
            <div style="background-color: #022130; font-family: Segoe UI Light; color: white; width: 300px; margin: 0 auto;" class="modal-content">
                <div class="modal-header" style="padding: 6px; border-bottom: 1px solid #4c636f;">
                    ...
                    <h4 class="modal-title" style="font-weight: bold; font-size: 14px;">Add Chamber: MessageBox</h4>
                </div>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    <asp:Label ID="Label2" runat="server" Text="Add a New Chamber"></asp:Label>                    
                </p>
                    ...
                    <table width="100%">
                         <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <asp:Label ID="lblFrmwrk" runat="server" Visible="false" Text="EAMS Framework Zone"></asp:Label>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtFramework"  ReadOnly="true" Visible="false" runat="server" class="textfield" Width="185" MaxLength="18"></asp:TextBox>

                            </td>
                            <td class="required"><asp:Label ID="lblChamberStatus" runat="server" Visible="false"  Text="EAMS Chamber Status"></asp:Label></td>
                            <td style="padding-left: 10px;">
                                <asp:TextBox ID="txtChamberStatus" ReadOnly="true" runat="server" Visible="false" class="textfield" Width="185" MaxLength="18"></asp:TextBox>
                            </td>
                        </tr>
						 <tr>
                            <td class="required" align="right" style="text-align: right;">
                                 <span style="color: red;">* </span><span class="normal">Framework Zone:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:DropDownList ID="FrameworkDD" runat="server" CssClass="textfield" Width="186px" AppendDataBoundItems="true">
                                    <asp:ListItem Value="-1" Selected="True">- Select Framework -</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="FrameworkDD" Display="None" InitialValue="-1"
                                    ValidationGroup="test" Text="*" ErrorMessage="Framework is Required" ForeColor="white" />
                            </td>
                             <td class="required">
                                 <span style="color: red;">* </span><span class="normal">Chamber Status:</span>
                             </td>
                            <td style="padding-left: 10px;">
                                <asp:DropDownList ID="ChamberStatusDD" runat="server" CssClass="textfield" Width="186px" AppendDataBoundItems="true">
                                    <asp:ListItem Value="-1" Selected="True">- Select Status -</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ChamberStatusDD" Display="None" InitialValue="-1"
                                    ValidationGroup="test" Text="*" ErrorMessage="Status is Required" ForeColor="white" />
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Chamber Name:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                        ...
                        <tr>
                             <td class="required" align="left" style="text-align: right;">
                                <span class="normal">Municipality :</span>
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="txtMuncipality" runat="server" class="textfield"  Width="186" />
                            </td>
                            <td class="required" align="right" style="text-align: right;">
                                <span class="normal">Location :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtLocation" runat="server" class="textfield" Width="185" ></asp:TextBox>
                            </td>
						...
						<tr>
							...
							<td class="requiredvalue" colspan="3">
								<asp:TextBox ID="txtCDMS" runat="server" class="textfield" Width="560" Height="70" TextMode="MultiLine" Wrap="true"></asp:TextBox>
							</td>
						</tr>
                        <tr>
