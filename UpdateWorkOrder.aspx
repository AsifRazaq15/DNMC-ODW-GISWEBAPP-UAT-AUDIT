                ...
                <table width="100%">
                    ...
                    <tr>
                            ...
                            <td style="padding-left: 10px;">
                                <asp:DropDownList ID="ddlFrameZone" runat="server" Enabled="false" CssClass="textfield" Width="186px" >
                                </asp:DropDownList>
                                <%--<asp:RequiredFieldValidator ControlToValidate="ddlOwnership" ID="RequiredFieldValidator2"
                    ...
                    <tr>
                        ...
                        <td class="requiredvalue">
                            ...
                            <asp:DropDownList ID="ddlPriority" runat="server" CssClass="textfield" Width="197" onchange="DispalyUnderpassOptions();">
