<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Scheduler.aspx.cs" Inherits="WebAppForm.Scheduler" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Scheduler - Work Order</title>
    <style type="text/css">
         .hiddencol {
            display: none;
        }
            ...
            <script type="text/javascript">
                function GetSelectedRow(lnk) {
                    ...
                    if (window.opener != null && !window.opener.closed) {
                        ...
                        window.opener.document.getElementById("ContentPlaceHolder1_txtScheduler").value = name;
