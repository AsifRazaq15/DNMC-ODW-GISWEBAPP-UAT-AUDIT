			...
			<td>
				...
				<div id="divone">
					...
					<table width="100%">
						...
						<tr>
							<td class="required" align="right" style="text-align: right;">
								<span style="color: red;">* </span><span class="normal">Muncipality :</span>
							</td>
							<td class="requiredvalue" style="text-align: left;">
								<asp:TextBox ID="txtMuncipality" runat="server" class="textfield" Width="185" MaxLength="18"></asp:TextBox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtMuncipality" Display="None"
									ValidationGroup="test" Text="*" ErrorMessage="Muncipality is Required" ForeColor="white" />

							</td>

							<td class="required" align="left" style="text-align: right;">
								<span style="color: red;">* </span><span class="normal">Location Description :</span>
							</td>
							<td class="requiredvalue">
								<asp:TextBox ID="txtLocDesc" runat="server" class="textfield" MaxLength="18" Width="186" />
								<asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtLocDesc" Display="None"
