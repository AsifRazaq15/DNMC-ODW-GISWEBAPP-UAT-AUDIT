                    ...
                    <table width="450px">
                        ...
                        <tr>
                            ...
                            <%--<td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Alarm Date:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtDateTime" runat="server" class="textfield" Width="286" MaxLength="18" Rows="4" Columns="34" ></asp:TextBox>
                            </td>--%>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: left;">
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:DropDownList ID="ddlName" runat="server" CssClass="textfield" Width="286px" EnableViewState="true" 
                                    AutoPostBack="true" OnSelectedIndexChanged="ddlName_SelectedIndexChanged" OnInit="ddlName_Init">
                                    <%--<asp:ListItem Value="-1" Selected="True">-- Select Contact --</asp:ListItem>--%>                                    
                                </asp:DropDownList>
                                <%--<asp:Button ID="btnGetContacts" runat="server" OnClick="btnGetContacts_Click" CssClass="simplebutton1" Text="Get Contacts" />--%>
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: left;">
                            ...
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:DropDownList ID="ddlContacts" runat="server" CssClass="textfield" Width="286px">
                                   <%-- <asp:ListItem Value="2264" Selected="True">Supervisor - 2264</asp:ListItem>
                                    <asp:ListItem Value="2265">Manager - 2265</asp:ListItem>
                                    <asp:ListItem Value="2266">Section Head - 2266</asp:ListItem>--%>
                                </asp:DropDownList>
                                <%--<asp:Button ID="btnGetContacts" runat="server" OnClick="btnGetContacts_Click" CssClass="simplebutton1" Text="Get Contacts" />--%>
                            </td>
                        </tr>
