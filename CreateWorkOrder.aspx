<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.CreateWorkOrder"
    Title=" Create WorkOrder" CodeBehind="CreateWorkOrder.aspx.cs" %>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    Create Rain FR WO - Express Form<br />
                </p>
                ...
                <div id="divone">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpdwnWorkType" runat="server" CssClass="textfield" Width="186px" Enabled="false" Style="margin-left: 8px; border: none;">
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;">
                             <%--   <asp:TextBox ID="txtScheduler" runat="server" class="textfield" Width="186" />
                                ...
                                <asp:DropDownList ID="Drpdwn_Scheduler" runat="server" CssClass="textfield" Width="186px">
                                </asp:DropDownList>
