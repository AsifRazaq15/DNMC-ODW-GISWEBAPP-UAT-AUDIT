<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.CreateBAUWorkOrder"
    Title="Create CM Work Order" CodeBehind="CreateBAUWorkOrder.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="table1" style="border-collapse: collapse;" width="100%" border="0">
        ...
        <tr>
            <td style="text-align: right;">
                <%-- <asp:HyperLink ID="linkWO" runat="server" NavigateUrl="~/WorkOrderList.aspx" Text="List View" Font-Bold="true" CssClass="wo"></asp:HyperLink>--%>
                    ...
                    <table width="100%">
                        <tr>
                            <td class="requiwhite" align="right" style="text-align: right; width: 18%;">
                                <span class="normal" style="font-weight: bold;"><span style="color: red;">* </span>WO Description:</span>
                            </td>
                            ...
                            <td class="requiredvalue" style="padding-right: 0px; padding-left: 7px; padding-top: 0px; padding-bottom: -1px;">
                                ...
                                <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectLocation()" Width="20" Height="20" ID="ImageButton3" Style="vertical-align: middle;" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="drpdwnWorkType" runat="server" CssClass="textfield" Enabled="false" Width="186px" Style="margin-left: 8px; border: none; -webkit-appearance: none;">
                                    <%--<asp:ListItem Value="FR" >FR - First Response</asp:ListItem>--%>
                                    <asp:ListItem Value="CM" Selected="True">CM - Corrective Maintenance</asp:ListItem>
                                </asp:DropDownList></td>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10px;">
                                <%--               <asp:Label ID="lblReportedBy" Height="17px" runat="server" class="textfield"
                                    Style="height: 30px; width: 185px;" BorderWidth="0" />
                                 <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectReportedBy()" Width="20" Height="20" ID="ImgReportedBy" Style="vertical-align: super;" />--%>
                        ...
                        <tr>
                            ...
                            <td class="requiredvalue" style="width: 34%;">
                                ...
                                <asp:DropDownList ID="DrpDwnPriority" runat="server" CssClass="textfield" Width="186px">
                                    <asp:ListItem Value="3" Selected="True">3- High</asp:ListItem>
                                    <asp:ListItem Value="4">4- Medium</asp:ListItem>
                                    <asp:ListItem Value="5">5- Low</asp:ListItem>
                                    <asp:ListItem Value="7">7- Very Low</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ControlToValidate="drpdwnWorkType" ValidationGroup="test" ID="RequiredFieldValidator3"
                        ...
                        <tr>
                            <td class="required"><span style="color: red;">* </span>Engineer:</td>
                            <td style="padding-left: 10px;">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEngineer" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Engineer is Required" ForeColor="white" />



                            </td>
                            <td class="required" align="right" style="text-align: right;"></td>
                            <td class="requiredvalue" style="text-align: left; padding-right: 0px; padding-left: 7px; padding-top: 10px;"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 20px; padding-left: 7px;">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" ValidationGroup="test" OnClick="btnSubmit_Click" CssClass="simplebutton1" Text="Create WO" />
                            </td>
                        </tr>
    ...
    <script type="text/javascript">
        ...
        function SelectEngineer() {
            popup = window.open("EngineerCC.aspx", "Popup", "width=800,height=720");
            popup.focus();
            return false;
        }
