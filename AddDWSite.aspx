<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.AddDWSite"
    Title="Add Chambers" CodeBehind="AddDWSite.aspx.cs" %>
        ...
        <div class="modal-dialog modal-sm">
            <div style="background-color: #022130; font-family: Segoe UI Light; color: white; width: 300px; margin: 0 auto;" class="modal-content">
                <div class="modal-header" style="padding: 6px; border-bottom: 1px solid #4c636f;">
                    ...
                    <h4 class="modal-title" style="font-weight: bold; font-size: 14px;">Add Dewatering Site: MessageBox</h4>
                </div>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    <asp:Label ID="Label2" runat="server" Text="Add a Dewatering Site"></asp:Label>                    
                </p>
                ...
                <div id="divone">
                    <table width="100%">
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td align="right" style= "padding-right:60px;"><asp:LinkButton ID="btnViewList" runat="server" Text="View List" OnClick="btnViewList_Click" Font-Bold="true" Font-Size="Medium" Font-Underline="true" ForeColor="White"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Permit No.:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtPermitNo" runat="server" class="textfield" Width="185" ></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPermitNo" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Permit No is required" ForeColor="white" />
                            </td>                            
                        </tr>                        
                        <tr>
                             <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">IP Address:</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtIPAddress" runat="server" class="textfield" Width="185" ></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtIPAddress" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="IP Address is required" ForeColor="white" />
                            </td>
                              <td class="required" align="left" style="text-align:right;padding: 17px 0 10px 5px !important">
                                <span class="normal">IsActive: </span>
                            </td>
                            <td class="requiredvalue">
                                <asp:CheckBox ID="CB_IsActive" runat="server" Style="margin:0 !important"/>
                            </td>
                        </tr>
                        <tr>
