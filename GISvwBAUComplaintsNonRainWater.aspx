<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.GISvwBAUComplaintsNonRainWater"
    Title="CRMS Complaint Detail" CodeBehind="GISvwBAUComplaintsNonRainWater.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ODWConnectionString %>"
      ...
      ,[DNMC_Fetch_Date]
      ,[DNMC_Fetch_Flag]    
  FROM [ODW].[GIS].[vwBAUComplaintsNonRainWater] where ([Service_Request_Number]= @ID)"
