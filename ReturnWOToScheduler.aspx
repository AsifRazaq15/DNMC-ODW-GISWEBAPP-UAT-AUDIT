<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.ReturnWOToScheduler"
    Title="Return WO to Scheduler" CodeBehind="ReturnWOToScheduler.aspx.cs" %>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    Return WO: Change Owner/Scheduler<br /></p>
                ...
                <table width="100%">
                    ...
                    <tr>
                            ...
                            <td style="padding-left: 10px;">
                                <asp:TextBox ID="txtFrameZone" runat="server" Enabled="false" CssClass="textfield" Width="186px" >
                                </asp:TextBox>                                
                            </td>                            
                        </tr>
                    <tr>
                        ...
                        <td class="requiredvalue">
                            ...
                            <asp:DropDownList ID="ddlPriority" runat="server" CssClass="textfield" Width="197" Enabled="false">
                    ...
                    <%--<tr>
                        <td class="required">
                            <span class="normal" style="font-weight: bold;">Contract Id:</span>
                        </td>
                        <td class="requiredvalue" style="text-align: left;padding-right: 0px;padding-left: 7px;padding-top: 5px;">
                            <asp:TextBox ID="txtContractId" runat="server" class="textfield" MaxLength="20" Width="186" BorderWidth="0" ReadOnly="true"/>
                            ...
                            <asp:ImageButton runat="server" ImageUrl="images/search.png" OnClientClick="SelectContract()" Width="20" Height="20" Visible="false" ID="ImageButton1" Style="vertical-align: middle;" />
                        </td>
