<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EngineerCC.aspx.cs" Inherits="WebAppForm.EngineerCC" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Engineer Contact Center - Work Order</title>
    <style type="text/css">
        .Grid {
    ...
    <form id="form1" runat="server" style="text-align: center;">
        <div>      
            <table>
                         ...
                         <tr>
                           ...
                           <td><asp:DropDownList ID="ddlField1" runat="server" CssClass="textfield" Width="150">
                                    ...
                                    <asp:ListItem Value="EXT_RESPSECTION">Section</asp:ListItem>
            ...
            <asp:GridView ID="gvEngineers" runat="server" AutoGenerateColumns="false" Font-Size="12px" Font-Names="Segoe UI Light"
                ...
                <Columns>
                    <asp:BoundField DataField="PERSONID" HeaderText="PERSON ID" ItemStyle-Width="70" />
                        <asp:BoundField DataField="DISPLAYNAME" HeaderText="DISPLAY NAME" />
                    <asp:BoundField DataField="EXT_RESPSECTION" HeaderText="RESP SECTION" ItemStyle-Width="80" />
            ...
            <script type="text/javascript">
                function GetSelectedRow(lnk) {
                    ...
                    if (window.opener != null && !window.opener.closed) {
                        ...
                        window.opener.document.getElementById("ContentPlaceHolder1_txtEngineer").setAttribute('title', country);
                        return false;
                    }
                    window.close();
                }
