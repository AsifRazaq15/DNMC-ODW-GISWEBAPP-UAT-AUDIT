<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.CreateBAUWOCustomer"
    Title="Ashgal WorkOrder Creation - Online Form Submission" CodeBehind="CreateBAUWOCustomer.aspx.cs" %>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    ECC Create BAU WO Customer - Express Form<br />
                </p>
