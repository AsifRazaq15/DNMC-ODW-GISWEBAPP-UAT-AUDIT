<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vehicle_List.aspx.cs" Inherits="WebAppForm.Vehicle_List" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Get Vehicle List</title>
    <style type="text/css">
        .Grid {
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlField1" runat="server" CssClass="textfield" Width="150">
                                <asp:ListItem Value="Title">Vehicle_No</asp:ListItem>
                                <asp:ListItem Value="Movement_Status">Movement_Status</asp:ListItem>
                                <asp:ListItem Value="Contractor">Contractor</asp:ListItem>
                                <asp:ListItem Value="Section">Section</asp:ListItem>
                                <asp:ListItem Value="Driver_Name">Driver_Name</asp:ListItem>
