<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="True" Inherits="WebAppForm.AddEditMXLocationAsset"
    Title="Add Asset" CodeBehind="AddEditMXLocationAsset.aspx.cs" %>
        ...
        <div class="modal-dialog modal-sm">
            <div style="background-color: #022130; font-family: Segoe UI Light; color: white; width: 300px; margin: 0 auto;" class="modal-content">
                <div class="modal-header" style="padding: 6px; border-bottom: 1px solid #4c636f;">
                    ...
                    <h4 class="modal-title" style="font-weight: bold; font-size: 14px;">Add MX Location Assets: MessageBox</h4>
                </div>
        ...
        <tr>
            <td>
                <p align="center" style="font-weight: bold; font-size: 20px; font-family: 'Segoe UI Light', Arial;">
                    <asp:Label ID="Label2" runat="server" Text="Add Asset"></asp:Label>                    
                </p>
                ...
                <div id="divone">
                    <table width="100%">
                        <tr>
                            <td class="required"><asp:Label ID="lblFrmwrk" runat="server" Visible="false" Text="Framework Zone"></asp:Label></td>
                            ...
                            <td class="required"><asp:Label ID="lblAssetStatus" runat="server" Visible="false" Text="Asset Status"></asp:Label></td>
                            <td style="padding-left: 10px;">
                                <asp:TextBox ID="txtAssetStatus" Visible="false" ReadOnly="true" runat="server" class="textfield" Width="185" MaxLength="18"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="requiredvalue">
                                <asp:DropDownList ID="ddMXLocation" runat="server" OnSelectedIndexChanged="OnMXLocationIndexChanged" AutoPostBack="True" CssClass="textfield" Width="186px" AppendDataBoundItems="true">
                                    <asp:ListItem Value="-1" Selected="True">- Select Location -</asp:ListItem>
                                    <asp:ListItem Value="Not Available">Not Available</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="required" align="left" style="text-align: right;">
                                <asp:Label ID="AssetsDDLbl" runat="server" Text="Assets" Visible="false"></asp:Label>
                            </td>
                            <td class="requiredvalue">
                                <asp:DropDownList ID="ddAssets" Visible="false" runat="server" OnSelectedIndexChanged="onAssetsIndexChanged" AutoPostBack="True" CssClass="textfield" Width="186px" AppendDataBoundItems="false">
                                    <asp:ListItem Value="-1" Selected="True">- Select Asset -</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Hierarchical Asset Name:</span>
                            </td>
                            ...
                            <td class="required" align="left" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Asset Name:</span>
                        ...
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Asset ID :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtAssetId" runat="server" class="textfield" Width="185" MaxLength="18"></asp:TextBox>
                                 <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                    FilterType="Numbers, Custom" ValidChars="."
                                    TargetControlID="txtAssetId">
                                </ajax:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtAssetId" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Muncipality is Required" ForeColor="white" />

                            </td>

                            <td class="required" align="left" style="text-align: right;">
                                <span style="color: red;">* </span><span class="normal">Asset Tag :</span>
                            </td>
                            <td class="requiredvalue">
                                <asp:TextBox ID="txtAssetTag" runat="server" class="textfield" MaxLength="30" Width="186" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtAssetTag" Display="None"
                                    ValidationGroup="test" Text="*" ErrorMessage="Location Description is Required" ForeColor="white" />
                            </td>
                        </tr>
                        <tr>
                            <td class="required" align="right" style="text-align: right;">
                                <%--<span style="color: red;">* </span>--%><span class="normal">Asset Description :</span>
                            </td>
                            <td class="requiredvalue" style="text-align: left;">
                                <asp:TextBox ID="txtAssetDesc" runat="server" class="textfield" Width="185"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style="padding-top: 20px; padding-left: 7px;">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" ValidationGroup="test" OnClick="btnSubmit_Click" CssClass="simplebutton1" Enabled="true" Text="Add Asset" />
                            </td>
                        </tr>
                    </table>
                </div>
